...
public class NotificationSchedulerIntentService extends IntentService {
    ...
    public static final String ACTION_SCHEDULE_NOTIFICATION = "fr.xebia.voxxeddays.zurich.service.ACTION_SCHEDULE_NOTIFICATION";
    public static final String ACTION_SCHEDULE_ALL_NOTIFICATIONS = "fr.xebia.voxxeddays.zurich.service.ACTION_SCHEDULE_ALL_NOTIFICATION";
    public static final String ACTION_SEND_NOTIFICATION = "fr.xebia.voxxeddays.zurich.service.ACTION_SEND_NOTIFICATION";
    public static final String ACTION_SEND_FEEDBACK_NOTIFICATION = "fr.xebia.voxxeddays.zurich.service.ACTION_SEND_FEEDBACK_NOTIFICATION";

    public static final String EXTRA_CONFERENCE_ID = "fr.xebia.voxxeddays.zurich.service.EXTRA_CONFERENCE_ID";
    public static final String EXTRA_TALK_ID = "fr.xebia.voxxeddays.zurich.service.EXTRA_TALK_ID";
    ...
    private int getTalkBackgroundResource(Talk talk) {
        return getResources().getIdentifier("devoxx_talk_template_" + talk.getPosition() % 11, "drawable", this.getPackageName());
    }
