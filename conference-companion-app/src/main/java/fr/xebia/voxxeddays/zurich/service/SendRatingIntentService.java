...
import static fr.xebia.voxxeddays.zurich.core.misc.Preferences.getUserScanIdForVote;

public class SendRatingIntentService extends IntentService {

    public static final String ACTION_SEND_RATING = "fr.xebia.voxxeddays.zurich.service.ACTION_SEND_RATING";

    private static final String EXTRA_CONFERENCE_ID = "fr.xebia.voxxeddays.zurich.service.EXTRA_CONFERENCE_ID";
    private static final String EXTRA_TALK_ID = "fr.xebia.voxxeddays.zurich.service.EXTRA_TALK_ID";
