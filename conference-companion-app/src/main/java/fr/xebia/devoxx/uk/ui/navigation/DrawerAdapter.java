package fr.xebia.devoxx.uk.ui.navigation;
...
public class DrawerAdapter extends BaseAdapter {
    ...
    public static final int MENU_FLOOR_PLAN = 3;
    ...
    public DrawerAdapter(Context context) {
        ...
        mItems.add(new DrawerItem(R.drawable.ic_floor_plan, R.string.floor_plan));
