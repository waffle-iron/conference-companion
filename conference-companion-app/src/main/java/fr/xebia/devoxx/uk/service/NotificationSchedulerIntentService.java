...
public class NotificationSchedulerIntentService extends IntentService {
    ...
    public static final String ACTION_SCHEDULE_NOTIFICATION = "fr.xebia.devoxx.uk.service.ACTION_SCHEDULE_NOTIFICATION";
    public static final String ACTION_SCHEDULE_ALL_NOTIFICATIONS = "fr.xebia.devoxx.uk.service.ACTION_SCHEDULE_ALL_NOTIFICATION";
    public static final String ACTION_SEND_NOTIFICATION = "fr.xebia.devoxx.uk.service.ACTION_SEND_NOTIFICATION";
    public static final String ACTION_SEND_FEEDBACK_NOTIFICATION = "fr.xebia.devoxx.uk.service.ACTION_SEND_FEEDBACK_NOTIFICATION";

    public static final String EXTRA_CONFERENCE_ID = "fr.xebia.devoxx.uk.service.EXTRA_CONFERENCE_ID";
    public static final String EXTRA_TALK_ID = "fr.xebia.devoxx.uk.service.EXTRA_TALK_ID";
