...
import fr.xebia.devoxx.be.core.utils.SqlUtils;
import fr.xebia.devoxx.be.model.Talk;
import fr.xebia.devoxx.be.ui.widget.CollectionView;
...
public class BrowseTalksFragment extends Fragment implements ManyQuery.ResultHandler<Talk> {
    ...
    public static String ARG_AVAILABLE_TALKS = "fr.xebia.devoxx.be.ARG_AVAILABLE_TALKS";
