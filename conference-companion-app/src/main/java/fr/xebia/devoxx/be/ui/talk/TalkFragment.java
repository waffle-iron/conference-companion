...
public class TalkFragment extends Fragment implements OneQuery.ResultHandler<Talk>, ManyQuery.ResultHandler<Speaker>,
    ...
    private static final String EXTRA_TALK_ID = "fr.xebia.devoxx.be.EXTRA_TALK_ID";
    private static final String EXTRA_TALK_TITLE = "fr.xebia.devoxx.be.EXTRA_TALK_TITLE";
    private static final String EXTRA_TALK_COLOR = "fr.xebia.devoxx.be.EXTRA_TALK_COLOR";
