...
import fr.xebia.devoxx.be.core.utils.TimeUtils;
import fr.xebia.devoxx.be.model.MyScheduleItem;
import fr.xebia.devoxx.be.model.Talk;
import fr.xebia.devoxx.be.ui.browse.BrowseTalksActivity;
...
public class MyScheduleAdapter implements ListAdapter, AbsListView.RecyclerListener {
    ...
    private int getTalkBackgroundResource(Talk talk) {
        return mContext.getResources().getIdentifier("devoxx_talk_template_" + talk.getPosition() % 19, "drawable", mContext.getPackageName());
    }
