...
import fr.xebia.devoxx.be.ui.widget.UnderlinedTextView;
...
public class SpeakerDetailsFragment extends Fragment implements OneQuery.ResultHandler<Speaker>, ManyQuery.ResultHandler<Talk> {
    ...
    public static final String EXTRA_SPEAKER_ID = "fr.xebia.devoxx.be.EXTRA_SPEAKER_ID";
    private static final String EXTRA_COLOR = "fr.xebia.devoxx.be.EXTRA_COLOR";
