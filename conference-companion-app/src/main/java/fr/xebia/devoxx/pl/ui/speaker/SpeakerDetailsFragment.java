package fr.xebia.devoxx.pl.ui.speaker;
...
import fr.xebia.devoxx.pl.core.transform.CircleTransform;
...
public class SpeakerDetailsFragment extends Fragment implements OneQuery.ResultHandler<Speaker>, ManyQuery.ResultHandler<Talk> {
    ...
    public static final String EXTRA_SPEAKER_ID = "fr.xebia.devoxx.pl.EXTRA_SPEAKER_ID";
    private static final String EXTRA_COLOR = "fr.xebia.devoxx.pl.EXTRA_COLOR";

    @InjectView(R.id.speaker_image) ImageView mSpeakerImage;
    @InjectView(R.id.speaker_name) TextView mSpeakerName;
    @InjectView(R.id.speaker_bio) UnderlinedTextView mSpeakerBio;
    @InjectView(R.id.speaker_bio_content) TextView mSpeakerBioContent;
    @InjectView(R.id.speaker_presentations) UnderlinedTextView mSpeakerPresentations;
    @InjectView(R.id.speaker_presentations_content) ViewGroup mSpeakerPresentationsContent;
