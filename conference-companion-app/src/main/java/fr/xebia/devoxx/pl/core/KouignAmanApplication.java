package fr.xebia.devoxx.pl.core;
...
import fr.xebia.devoxx.pl.api.ConferenceApi;
import fr.xebia.devoxx.pl.api.VoteApi;
import fr.xebia.devoxx.pl.bus.SyncEvent;
import fr.xebia.devoxx.pl.core.db.DbSchema;
import fr.xebia.devoxx.pl.core.misc.Preferences;
import fr.xebia.devoxx.pl.core.network.JacksonConverter;
...
public class KouignAmanApplication extends Application {
    ...
    public void onCreate() {
        ...
        if(Preferences.getSelectedConference(this) != BuildConfig.DEVOXX_PL_CONFERENCE_ID) {
