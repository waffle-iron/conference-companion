package fr.xebia.devoxx.pl.ui.talk;
...
import fr.xebia.devoxx.pl.bus.MemoSavedEvent;
...
import fr.xebia.devoxx.pl.model.Vote;
import fr.xebia.devoxx.pl.ui.note.MemoActivity;
import fr.xebia.devoxx.pl.ui.question.QuestionsActivity;
import fr.xebia.devoxx.pl.ui.speaker.SpeakerDetailsActivity;
import fr.xebia.devoxx.pl.ui.widget.CheckableFrameLayout;
import fr.xebia.devoxx.pl.ui.widget.ObservableScrollView;
import fr.xebia.devoxx.pl.ui.widget.UIUtils;
import fr.xebia.devoxx.pl.ui.widget.UnderlinedTextView;
...
import static fr.xebia.devoxx.pl.service.NotificationSchedulerIntentService.buildScheduleNotificationIntentFromTalk;
import static fr.xebia.devoxx.pl.service.SendRatingIntentService.buildSendRatingIntent;
import static fr.xebia.devoxx.pl.ui.question.QuestionsActivity.EXTRA_ROOM;
...
public class TalkFragment extends Fragment implements OneQuery.ResultHandler<Talk>, ManyQuery.ResultHandler<Speaker>,
    ...
    private static final String EXTRA_TALK_ID = "fr.xebia.devoxx.pl.EXTRA_TALK_ID";
    private static final String EXTRA_TALK_TITLE = "fr.xebia.devoxx.pl.EXTRA_TALK_TITLE";
    private static final String EXTRA_TALK_COLOR = "fr.xebia.devoxx.pl.EXTRA_TALK_COLOR";
