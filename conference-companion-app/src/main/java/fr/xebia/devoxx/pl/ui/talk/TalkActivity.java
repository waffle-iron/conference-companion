...
public class TalkActivity extends BaseActivity {
    ...
    public static final String EXTRA_TALK_ID = "fr.xebia.devoxx.pl.EXTRA_TALK_ID";
    public static final String EXTRA_TALK_TITLE = "fr.xebia.devoxx.pl.EXTRA_TALK_TITLE";
    public static final String EXTRA_TALK_COLOR = "fr.xebia.devoxx.pl.EXTRA_TALK_COLOR";
