package fr.xebia.devoxx.pl.ui.browse;
...
import fr.xebia.devoxx.pl.core.activity.BaseActivity.OnActionBarAutoShowOrHideListener;
...
public class BrowseTalksActivity extends BaseActivity implements OnActionBarAutoShowOrHideListener {
    ...
    public static final String EXTRA_TITLE = "fr.xebia.devoxx.pl.EXTRA_TITLE";
    public static String EXTRA_AVAILABLE_TALKS = "fr.xebia.devoxx.pl.EXTRA_AVAILABLE_TALKS";
