...
import fr.xebia.devoxx.pl.ui.schedule.MyScheduleActivity;
import fr.xebia.devoxx.pl.ui.talk.TalkActivity;
import se.emilsjolander.sprinkles.Query;

public class NotificationSchedulerIntentService extends IntentService {

    public static final String ACTION_SCHEDULE_NOTIFICATION = "fr.xebia.devoxx.pl.service.ACTION_SCHEDULE_NOTIFICATION";
    public static final String ACTION_SCHEDULE_ALL_NOTIFICATIONS = "fr.xebia.devoxx.pl.service.ACTION_SCHEDULE_ALL_NOTIFICATION";
    public static final String ACTION_SEND_NOTIFICATION = "fr.xebia.devoxx.pl.service.ACTION_SEND_NOTIFICATION";
    public static final String ACTION_SEND_FEEDBACK_NOTIFICATION = "fr.xebia.devoxx.pl.service.ACTION_SEND_FEEDBACK_NOTIFICATION";

    public static final String EXTRA_CONFERENCE_ID = "fr.xebia.devoxx.pl.service.EXTRA_CONFERENCE_ID";
    public static final String EXTRA_TALK_ID = "fr.xebia.devoxx.pl.service.EXTRA_TALK_ID";
