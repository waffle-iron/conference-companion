...
import static fr.xebia.xebicon.core.misc.Preferences.getUserScanIdForVote;

public class SendRatingIntentService extends IntentService {

    public static final String ACTION_SEND_RATING = "fr.xebia.xebicon.service.ACTION_SEND_RATING";

    private static final String EXTRA_CONFERENCE_ID = "fr.xebia.xebicon.service.EXTRA_CONFERENCE_ID";
    private static final String EXTRA_TALK_ID = "fr.xebia.xebicon.service.EXTRA_TALK_ID";
    ...
    protected void onHandleIntent(Intent intent) {
        ...
        try {
            Response response = fr.xebia.xebicon.core.XebiConApplication.getVoteApi().sendRating(buildRating(vote));
