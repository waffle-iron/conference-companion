...
public class DrawerAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        icon.setColorFilter(position == mSelectedPosition ? Color.WHITE : Color.BLACK, PorterDuff.Mode.SRC_IN);
        holder.mText.setTextColor(position == mSelectedPosition ? Color.WHITE : Color.BLACK);
